...
import { 
  ...
  Bell, CheckSquare, Users, Database, Send, PhoneCall, FileCheck, Car, Monitor, Image, MessageSquare, Mail, Recycle, Calculator
} from 'lucide-react';
  ...
  const menu = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'SUPPLIER_QUOTATION', label: 'Supplier Quotation', icon: Receipt },
        { id: 'PURCHASE_ORDER', label: 'Purchase Order', icon: FileText },
        { id: 'PURCHASE_INWARD', label: 'Purchase Receipt', icon: ArrowRightLeft },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'PRODUCTION', label: 'Work Order', icon: ClipboardList },
        { id: 'TRACK_LOTS', label: 'Tracking', icon: MapPin },
        { id: 'FABRIC_COSTING', label: 'Garment Costing', icon: Coins },
        { id: 'MARGIN_COSTING', label: 'Real-Time Margin Costing Engine', icon: Calculator },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'DOCTYPE_CENTER', label: 'DocType Center', icon: Layers },
