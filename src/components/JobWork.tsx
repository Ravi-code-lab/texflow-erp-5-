...
export default function JobWorkComp({ 
  ...
  return (
    <div className="flex flex-col h-full bg-[#f8f9fa] dark:bg-slate-950 -mx-4 -my-5 px-4 py-5 lg:-m-6 lg:p-6 space-y-6">
            ...
            <div className="p-8 border-4 border-double border-slate-300 bg-white text-slate-800 max-w-3xl mx-auto rounded-lg shadow-inner leading-relaxed family-sans select-all">
              ...
              <div className="flex items-center justify-center gap-4 border-b-2 border-slate-900 pb-4">
                ...
                <div className="text-center space-y-1.5 ">
                  <h2 className="text-xl font-black uppercase tracking-widest text-[#1b6bf9]">{companyInfo?.name || 'TEXFLOW INTEGRATED APPARELS MILLS'}</h2>
                  <p className="text-[10px] text-slate-500 font-bold uppercase whitespace-pre-wrap">
                    {companyInfo?.address || 'Surat Industrial Sector B, Block 4-7, Gujarat'}
                    {companyInfo?.gstin ? ` • GSTIN: ${companyInfo.gstin}` : ' • GSTIN: 24AAECT3211C1ZX'}
                  </p>
