...
export interface JobWork extends BaseEntity { challanNumber: string; vendorName: string; process: string; issueDate: string; expectedDate: string; status: string; items: JobWorkItem[]; totalCost: number; paymentStatus: string; sourceWorkOrderId?: string; sourceOperationId?: string; styleCode?: string; color?: string; fabricLot?: string; }
