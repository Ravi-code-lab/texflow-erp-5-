...
export const ERP_MODULE_GROUPS: ERPModuleGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'WHATSAPP', label: 'WhatsApp', doctype: 'Communication', module: 'selling', icon: MessageSquare, description: 'WhatsApp messaging and campaigns' },
    ],
  },
  {
    id: 'buying',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'TALLY_INTEGRATION', label: 'Tally Sync Integration', doctype: 'Tally Integration Settings', module: 'accounts_hr', icon: ArrowRightLeft, description: '2-way transactional sync with Tally ERP 9 / TallyPrime', keywords: ['tally', 'co-accounting', 'ledgers', 'sync', 'integration', 'vouchers'] },
