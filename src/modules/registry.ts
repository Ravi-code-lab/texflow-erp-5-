...
export const ERP_MODULE_GROUPS: ERPModuleGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'YARN_MANAGEMENT', label: 'Fabric Roll & Trim Inventory', doctype: 'Fabric Roll Inventory', module: 'manufacturing', icon: Layers, description: 'Manage fabric rolls, meters, GSM, RAYON/COTTON selections, and trim accessories', keywords: ['fabric', 'rayon', 'cotton', 'meters', 'gsm', 'laces', 'buttons', 'accessories'] },
      { id: 'DYEING_PROCESSING', label: 'Embroidery, Print & Wash Cards', doctype: 'Embroidery & Print Batch', module: 'manufacturing', icon: Palette, description: 'Track neck embroidery, custom prints, dyeing/washing cycles, and pH tests', keywords: ['embroidery', 'print', 'stamping', 'wash', 'color', 'pantone', 'chem'] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'DISPATCH_PLANNER', label: 'Apparel Dispatch Planner', doctype: 'Dispatch Log', module: 'stock', icon: Truck, description: 'Plan logistic shipping modes, driver logs, and E-Way bills', keywords: ['shipping', 'delivery', 'transport', 'eway', 'driver'] },
