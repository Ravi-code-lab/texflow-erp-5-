...
const INDIAN_GST_COA: AccountItem[] = [
  ...
  { id: 'hdfc_bank', parentId: 'cash_bank', code: '1111', name: 'HDFC Bank - Current Account', rootType: 'Asset', accountType: 'Bank', isGroup: false, balance: 485000, currency: 'INR', reportType: 'Balance Sheet', isReconciliable: true },
  { id: 'sbi_bank', parentId: 'cash_bank', code: '1112', name: 'SBI Bank - OD Account', rootType: 'Asset', accountType: 'Bank', isGroup: false, balance: 120000, currency: 'INR', reportType: 'Balance Sheet', isReconciliable: true },
  { id: 'petty_cash', parentId: 'cash_bank', code: '1113', name: 'Petty Cash', rootType: 'Asset', accountType: 'Cash', isGroup: false, balance: 15000, currency: 'INR', reportType: 'Balance Sheet' },
  { id: 'acc_receivable', parentId: 'current_assets', code: '1120', name: 'Accounts Receivable', rootType: 'Asset', accountType: 'Receivable', isGroup: false, balance: 320000, currency: 'INR', reportType: 'Balance Sheet', isReconciliable: true },
  { id: 'advance_tax', parentId: 'current_assets', code: '1130', name: 'Advance Tax & TDS Receivable', rootType: 'Asset', accountType: 'Tax', isGroup: false, balance: 42000, currency: 'INR', reportType: 'Balance Sheet' },
  ...
  { id: 'cgst_input', parentId: 'gst_input', code: '1141', name: 'CGST Input - 9%', rootType: 'Asset', accountType: 'Tax', isGroup: false, balance: 18000, currency: 'INR', taxRate: 9, reportType: 'Balance Sheet' },
  { id: 'sgst_input', parentId: 'gst_input', code: '1142', name: 'SGST Input - 9%', rootType: 'Asset', accountType: 'Tax', isGroup: false, balance: 18000, currency: 'INR', taxRate: 9, reportType: 'Balance Sheet' },
  { id: 'igst_input', parentId: 'gst_input', code: '1143', name: 'IGST Input - 18%', rootType: 'Asset', accountType: 'Tax', isGroup: false, balance: 9500, currency: 'INR', taxRate: 18, reportType: 'Balance Sheet' },
  ...
  { id: 'raw_material', parentId: 'inventory', code: '1151', name: 'Raw Material Stock', rootType: 'Asset', accountType: 'Stock', isGroup: false, balance: 250000, currency: 'INR', reportType: 'Balance Sheet' },
  { id: 'wip', parentId: 'inventory', code: '1152', name: 'Work In Progress', rootType: 'Asset', accountType: 'Stock', isGroup: false, balance: 85000, currency: 'INR', reportType: 'Balance Sheet' },
  { id: 'finished_goods', parentId: 'inventory', code: '1153', name: 'Finished Goods Stock', rootType: 'Asset', accountType: 'Stock', isGroup: false, balance: 192000, currency: 'INR', reportType: 'Balance Sheet' },
  { id: 'prepaid_exp', parentId: 'current_assets', code: '1160', name: 'Prepaid Expenses', rootType: 'Asset', accountType: 'Other', isGroup: false, balance: 28000, currency: 'INR', reportType: 'Balance Sheet' },
  ...
  { id: 'plant_mach', parentId: 'fixed_assets', code: '1210', name: 'Plant & Machinery', rootType: 'Asset', accountType: 'Fixed Asset', isGroup: false, balance: 1200000, currency: 'INR', reportType: 'Balance Sheet' },
  { id: 'acc_dep_pm', parentId: 'fixed_assets', code: '1211', name: 'Accumulated Depreciation - P&M', rootType: 'Asset', accountType: 'Accumulated Depreciation', isGroup: false, balance: -180000, currency: 'INR', reportType: 'Balance Sheet' },
  { id: 'furniture', parentId: 'fixed_assets', code: '1220', name: 'Furniture & Fixtures', rootType: 'Asset', accountType: 'Fixed Asset', isGroup: false, balance: 85000, currency: 'INR', reportType: 'Balance Sheet' },
  { id: 'computers', parentId: 'fixed_assets', code: '1230', name: 'Computer & Peripherals', rootType: 'Asset', accountType: 'Fixed Asset', isGroup: false, balance: 45000, currency: 'INR', reportType: 'Balance Sheet' },
  { id: 'vehicles', parentId: 'fixed_assets', code: '1240', name: 'Vehicles', rootType: 'Asset', accountType: 'Fixed Asset', isGroup: false, balance: 650000, currency: 'INR', reportType: 'Balance Sheet' },
  { id: 'acc_dep_v', parentId: 'fixed_assets', code: '1241', name: 'Accumulated Depreciation - Vehicles', rootType: 'Asset', accountType: 'Accumulated Depreciation', isGroup: false, balance: -65000, currency: 'INR', reportType: 'Balance Sheet' },
  ...
  { id: 'fd_investments', parentId: 'investments_grp', code: '1310', name: 'Fixed Deposits', rootType: 'Asset', accountType: 'Investments', isGroup: false, balance: 500000, currency: 'INR', reportType: 'Balance Sheet' },
  ...
  { id: 'acc_payable', parentId: 'current_liab', code: '2110', name: 'Accounts Payable', rootType: 'Liability', accountType: 'Payable', isGroup: false, balance: 215000, currency: 'INR', reportType: 'Balance Sheet', isReconciliable: true },
  ...
  { id: 'cgst_output', parentId: 'gst_output', code: '2121', name: 'CGST Output - 9%', rootType: 'Liability', accountType: 'Tax', isGroup: false, balance: 27000, currency: 'INR', taxRate: 9, reportType: 'Balance Sheet' },
  { id: 'sgst_output', parentId: 'gst_output', code: '2122', name: 'SGST Output - 9%', rootType: 'Liability', accountType: 'Tax', isGroup: false, balance: 27000, currency: 'INR', taxRate: 9, reportType: 'Balance Sheet' },
  { id: 'igst_output', parentId: 'gst_output', code: '2123', name: 'IGST Output - 18%', rootType: 'Liability', accountType: 'Tax', isGroup: false, balance: 13500, currency: 'INR', taxRate: 18, reportType: 'Balance Sheet' },
  { id: 'tds_payable', parentId: 'current_liab', code: '2130', name: 'TDS Payable', rootType: 'Liability', accountType: 'Tax', isGroup: false, balance: 18500, currency: 'INR', reportType: 'Balance Sheet' },
  { id: 'salary_payable', parentId: 'current_liab', code: '2140', name: 'Salary & Wages Payable', rootType: 'Liability', accountType: 'Payroll Payable', isGroup: false, balance: 95000, currency: 'INR', reportType: 'Balance Sheet' },
  { id: 'advances_received', parentId: 'current_liab', code: '2150', name: 'Customer Advances Received', rootType: 'Liability', accountType: 'Payable', isGroup: false, balance: 50000, currency: 'INR', reportType: 'Balance Sheet' },
  ...
  { id: 'bank_loan', parentId: 'long_term_liab', code: '2210', name: 'Term Loan - HDFC Bank', rootType: 'Liability', accountType: 'Loans (Liability)', isGroup: false, balance: 800000, currency: 'INR', reportType: 'Balance Sheet' },
  { id: 'vehicle_loan', parentId: 'long_term_liab', code: '2220', name: 'Vehicle Loan - Kotak Finance', rootType: 'Liability', accountType: 'Loans (Liability)', isGroup: false, balance: 350000, currency: 'INR', reportType: 'Balance Sheet' },
  ...
  { id: 'share_capital', parentId: 'equity', code: '3100', name: 'Share Capital', rootType: 'Equity', accountType: 'Capital Stock', isGroup: false, balance: 1000000, currency: 'INR', reportType: 'Balance Sheet' },
  ...
  { id: 'general_reserve', parentId: 'reserves', code: '3210', name: 'General Reserve', rootType: 'Equity', accountType: 'Retained Earnings', isGroup: false, balance: 350000, currency: 'INR', reportType: 'Balance Sheet' },
  { id: 'retained_earnings', parentId: 'reserves', code: '3220', name: 'Retained Earnings (P&L)', rootType: 'Equity', accountType: 'Retained Earnings', isGroup: false, balance: 480000, currency: 'INR', reportType: 'Balance Sheet' },
  { id: 'partners_cap', parentId: 'equity', code: '3300', name: 'Partners Capital Account', rootType: 'Equity', accountType: 'Capital Stock', isGroup: false, balance: 600000, currency: 'INR', reportType: 'Balance Sheet' },
  ...
  { id: 'sales_textile', parentId: 'direct_income', code: '4110', name: 'Sales - Textile Products', rootType: 'Income', accountType: 'Direct Income', isGroup: false, balance: 1850000, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'sales_export', parentId: 'direct_income', code: '4120', name: 'Export Sales', rootType: 'Income', accountType: 'Direct Income', isGroup: false, balance: 420000, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'service_income', parentId: 'direct_income', code: '4130', name: 'Job Work & Service Income', rootType: 'Income', accountType: 'Direct Income', isGroup: false, balance: 185000, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'sales_return', parentId: 'direct_income', code: '4140', name: 'Sales Returns (Contra)', rootType: 'Income', accountType: 'Direct Income', isGroup: false, balance: -42000, currency: 'INR', reportType: 'Profit and Loss' },
  ...
  { id: 'interest_income', parentId: 'indirect_income', code: '4210', name: 'Interest Received on FD', rootType: 'Income', accountType: 'Indirect Income', isGroup: false, balance: 38000, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'discount_received', parentId: 'indirect_income', code: '4220', name: 'Discount Received from Suppliers', rootType: 'Income', accountType: 'Indirect Income', isGroup: false, balance: 12500, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'misc_income', parentId: 'indirect_income', code: '4230', name: 'Miscellaneous Income', rootType: 'Income', accountType: 'Indirect Income', isGroup: false, balance: 8000, currency: 'INR', reportType: 'Profit and Loss' },
  ...
  { id: 'raw_mat_cons', parentId: 'direct_exp', code: '5110', name: 'Raw Material Consumption', rootType: 'Expense', accountType: 'Cost of Goods Sold', isGroup: false, balance: 980000, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'direct_wages', parentId: 'direct_exp', code: '5120', name: 'Direct Labour & Wages', rootType: 'Expense', accountType: 'Direct Expense', isGroup: false, balance: 345000, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'jobwork_exp', parentId: 'direct_exp', code: '5130', name: 'Job Work Charges Paid', rootType: 'Expense', accountType: 'Direct Expense', isGroup: false, balance: 128000, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'freight_in', parentId: 'direct_exp', code: '5140', name: 'Freight Inward', rootType: 'Expense', accountType: 'Direct Expense', isGroup: false, balance: 48000, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'factory_power', parentId: 'direct_exp', code: '5150', name: 'Factory Power & Water', rootType: 'Expense', accountType: 'Direct Expense', isGroup: false, balance: 72000, currency: 'INR', reportType: 'Profit and Loss' },
  ...
  { id: 'salaries_adm', parentId: 'indirect_exp', code: '5210', name: 'Salaries - Administrative', rootType: 'Expense', accountType: 'Indirect Expense', isGroup: false, balance: 420000, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'office_rent', parentId: 'indirect_exp', code: '5220', name: 'Office Rent & Utilities', rootType: 'Expense', accountType: 'Indirect Expense', isGroup: false, balance: 120000, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'depreciation', parentId: 'indirect_exp', code: '5230', name: 'Depreciation (Annual)', rootType: 'Expense', accountType: 'Depreciation', isGroup: false, balance: 95000, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'bank_charges', parentId: 'indirect_exp', code: '5240', name: 'Bank Charges & Interest', rootType: 'Expense', accountType: 'Indirect Expense', isGroup: false, balance: 18500, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'travel_exp', parentId: 'indirect_exp', code: '5250', name: 'Travel & Conveyance', rootType: 'Expense', accountType: 'Indirect Expense', isGroup: false, balance: 34000, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'professional_fees', parentId: 'indirect_exp', code: '5260', name: 'Professional & Legal Fees', rootType: 'Expense', accountType: 'Indirect Expense', isGroup: false, balance: 45000, currency: 'INR', reportType: 'Profit and Loss' },
  ...
  { id: 'freight_out', parentId: 'selling_dist', code: '5271', name: 'Freight Outward', rootType: 'Expense', accountType: 'Indirect Expense', isGroup: false, balance: 36000, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'commission_sales', parentId: 'selling_dist', code: '5272', name: 'Sales Commission', rootType: 'Expense', accountType: 'Indirect Expense', isGroup: false, balance: 28500, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'advertisement', parentId: 'selling_dist', code: '5273', name: 'Advertisement & Branding', rootType: 'Expense', accountType: 'Indirect Expense', isGroup: false, balance: 15000, currency: 'INR', reportType: 'Profit and Loss' },
  { id: 'other_exp', parentId: 'indirect_exp', code: '5280', name: 'Other Miscellaneous Expenses', rootType: 'Expense', accountType: 'Indirect Expense', isGroup: false, balance: 12000, currency: 'INR', reportType: 'Profit and Loss' },
];
...
const ChartOfAccounts: React.FC = () => {
  ...
  const handlePostJournal = () => {
    ...
    if (!jDebit || !jCredit) { alert('Select both Debit and Credit accounts.'); return; }
    if (jDebit === jCredit) { alert('Debit and Credit accounts must be different.'); return; }
    const dr = accounts.find(a => a.id === jDebit)!;
    const cr = accounts.find(a => a.id === jCredit)!;
    const isDebitNormal = ['Asset', 'Expense'].includes(dr.rootType);
    const isCreditNormal = ['Liability', 'Equity', 'Income'].includes(cr.rootType);
    setAccounts(prev => prev.map(a => {
      if (a.id === jDebit) return { ...a, balance: (a.balance || 0) + (isDebitNormal ? amt : -amt) };
      if (a.id === jCredit) return { ...a, balance: (a.balance || 0) + (isCreditNormal ? amt : -amt) };
      return a;
    }));
    const entry: JournalEntry = {
      id: `JV-${Date.now()}`,
      timestamp: new Date().toLocaleString('en-IN', { dateStyle: 'short', timeStyle: 'short' }),
      drAccountId: jDebit, crAccountId: jCredit,
      drAccountName: dr.name, crAccountName: cr.name,
      amount: amt, memo: jMemo || 'Manual journal entry',
            ...
            {activeRightTab === 'journal' && (
              <div className="space-y-4">
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <label className="text-[9px] font-black uppercase text-slate-400 block mb-1">Debit Account (DR)</label>
                      <select value={jDebit} onChange={e => setJDebit(e.target.value)}
                        className="w-full px-2.5 py-2 text-xs border border-slate-200 dark:border-slate-700 rounded-lg bg-slate-50 dark:bg-slate-800 outline-none focus:ring-1 focus:ring-indigo-500">
                    ...
                    <div>
                      <label className="text-[9px] font-black uppercase text-slate-400 block mb-1">Credit Account (CR)</label>
                      <select value={jCredit} onChange={e => setJCredit(e.target.value)}
                        className="w-full px-2.5 py-2 text-xs border border-slate-200 dark:border-slate-700 rounded-lg bg-slate-50 dark:bg-slate-800 outline-none focus:ring-1 focus:ring-indigo-500">
                        <option value="">-- Select --</option>
                        {leafAccounts.map(a => <option key={a.id} value={a.id}>{a.code} - {a.name}</option>)}
                      </select>
                  ...
                  <div>
                    <label className="text-[9px] font-black uppercase text-slate-400 block mb-1">Amount ({companyConfig.currency})</label>
                    <input type="number" value={jAmount} onChange={e => setJAmount(e.target.value)} placeholder="0.00"
                  ...
                  <div>
                    <label className="text-[9px] font-black uppercase text-slate-400 block mb-1">Narration / Memo</label>
                  ...
                  <button onClick={handlePostJournal}
                    className="w-full py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold uppercase rounded-lg flex items-center justify-center gap-2 transition-colors shadow-sm">
                      ...
                      <div key={j.id} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-3 text-xs">
                        ...
                        <div className="space-y-1 text-[11px]">
                          <div className="flex items-center gap-1.5 text-blue-700 dark:text-blue-300">
                            ...
                            <span className="truncate">{j.drAccountName}</span>
                          </div>
                          <div className="flex items-center gap-1.5 text-orange-700 dark:text-orange-300">
                            ...
                            <span className="truncate">{j.crAccountName}</span>
                          </div>
                        </div>
                        <div className="flex items-center justify-between mt-2 pt-2 border-t border-slate-100 dark:border-slate-800">
                          <span className="text-slate-400 italic truncate max-w-[60%]">{j.memo}</span>
                          <span className="font-mono font-bold text-emerald-600 dark:text-emerald-400">{formatCurrency(j.amount)}</span>
                        </div>
                      </div>
                    ))}
                  </div>
